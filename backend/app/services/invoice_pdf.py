...
INVOICE_PDF_TRANSLATIONS = {
    "pt-BR": {
        ...
        "payment_method_stripe": "Stripe (Pagamento Online)",
        "payment_method_pix_manual": "PIX (Manual)",
        "payment_method_boleto_manual": "Boleto (Manual)",
    ...
    "en": {
        ...
        "payment_method_stripe": "Stripe (Online Payment)",
        "payment_method_pix_manual": "PIX (Manual)",
        "payment_method_boleto_manual": "Boleto (Manual)",
